...
class DocumentSearchTool(BaseTool):
    ...
    def _process_document(self):
        ...
        metadata = [
            {"source": os.path.basename(self.file_path)} for _ in range(len(chunks))
        ]
    ...
    def _run(self, query: str) -> list:
        ...
        relevant_chunks = self.client.query(
            collection_name="demo_collection", query_text=query
        )
...
def test_document_searcher():
    # Test file path
    pdf_path = (
        # "/Users/akshaypachaar/Eigen/ai-engineering/agentic_rag/knowledge/dspy.pdf"
        "D:\qwen3\dspy.pdf"
    )
